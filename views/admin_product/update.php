<?php
	include ROOT . '/layouts/header_admin.php';
?>
						...
						<div class="login-form">
							<form action="#" method="post" enctype="multipart/form-data">
								...
								<select name="availabillity">
									<option value="1" <?php if ($product['availabillity'] == 1) echo ' selected="selected"'; ?>>Да</option>
									<option value="0" <?php if ($product['availabillity'] == 0) echo ' selected="selected"'; ?>>Нет</option>
								</select>
...
<?php
	include ROOT . '/layouts/footer_admin.php';
?>